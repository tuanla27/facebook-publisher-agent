const transitions = {
  CONVERSATIONAL_INTAKE: new Set(["ATTACHMENTS_RECEIVED", "INPUT_RECEIVED", "FAILED"]),
  ATTACHMENTS_RECEIVED: new Set(["ASSETS_MATERIALIZED", "FAILED"]),
  ASSETS_MATERIALIZED: new Set(["INPUT_RECEIVED", "FAILED"]),
  ...
  PUBLISHED: new Set(),
  REJECTED: new Set(),
  FAILED: new Set(["ATTACHMENTS_RECEIVED", "INPUT_RECEIVED", "DRAFT_GENERATED", "PUBLISHING"])
};
